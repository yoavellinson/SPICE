...
class AudioDataset(VisionDataset):
    ...
    def __init__(
        ...
        super(AudioDataset, self).__init__(root, transform=transform,
        ...
        self.data,self.labels = self.load_audio_dataset,None
    ...
    def load_audio_dataset(self,path):
        return None
